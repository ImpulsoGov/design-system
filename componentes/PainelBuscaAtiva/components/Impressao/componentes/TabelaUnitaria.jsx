                ...
                <th style={{
                  ...
                  {coluna.headerComplement && (
                    <div style={{
                      ...
                      display: !coluna.visibleHeaderComplement && orientacao == "retrato" ? "none" : "block"
                    }}>
                      {coluna.headerComplement}
                    </div>
                  )}
              ...
              >
                {colunas.map((coluna,index) => (
                  ...
                  >
                    ...
                    {
                      coluna.field === "id_status_polio" && <StatusEsquema orientacao={orientacao} value={item[coluna.field]} />
                    }
                    {
                      coluna.field === "id_status_penta" && <StatusEsquema orientacao={orientacao} value={item[coluna.field]} />
                    }
                    {
